...
**สมาชิกทีม:**
- นักพัฒนาหลัก: กฤตหัสต์ วัฒนาไชย 68114540038
หน้าที่ที่รับผิดชอบ: pieces.py: สร้างคลาส Tetromino พื้นฐานและคลาสลูก (I, O, T, ฯลฯ) จัดการระบบสืบทอด (Inheritance) และการทำงานหลายรูปแบบ (Polymorphism) สำหรับการหมุนชิ้นส่วน
board.py: พัฒนาตรรกะของกระดานเกมทั้งหมด เช่น การตรวจสอบพื้นที่ว่าง, การล็อกชิ้นส่วนที่ตกลงมา, และการคำนวณเพื่อลบแถวที่เต็ม (Encapsulation)
game.py: เขียนตัวควบคุมเกมหลัก (Main Controller) ที่นำเอาคอมโพเนนต์ต่างๆ มารวมกัน (Composition) และจัดการวงจรการทำงานของเกม (Game Loop)

- นักพัฒนาร่วม: กิตติพงษ์ เลี้ยงหิรัญถาวร 68114540777
หน้าที่ที่รับผิดชอบ: renderer.py: พัฒนาระบบการแสดงผลกราฟิกด้วย Pygame รับผิดชอบการวาดกระดานและชิ้นส่วนต่างๆ ลงบนหน้าจอ
input_handler.py: จัดการกับเหตุการณ์ที่เกิดจากผู้เล่น (Input Events) เช่น การกดปุ่มลูกศรเพื่อเลื่อนชิ้นส่วน หรือกด Spacebar เพื่อให้ชิ้นส่วนตกลงทันที
config.py: ดูแลและปรับแต่งค่าคงที่ของเกม เช่น ขนาดหน้าจอ, โทนสี, และระดับความยาก
Project Setup & Testing: ดูแลไฟล์ pyproject.toml และ requirements.txt รวมถึงตั้งค่าเครื่องมือเสริมสำหรับการพัฒนา เช่น pytest สำหรับเขียนเทสต์, black สำหรับจัดฟอร์แมตโค้ด, และ mypy สำหรับตรวจสอบ Type Hint
